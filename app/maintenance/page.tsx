  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {records.map(m => (
          <div key={m.id} className="card flex items-center justify-between gap-4 overflow-hidden style={m.next_date && isUrgent(m.next_date) ? {borderColor: 'rgba(245,158,11,0.3)'} : {}}>
