        ...
        {vehicles.map(v => (
          <div key={v.id} className="card flex items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0" style={{backgroundColor: 'rgba(59,91,219,0.1)', border: '1px solid rgba(59,91,219,0.2)'}}>
